...
The live aggregate report is [CDP_TRACK_B_FINAL_QUALIFICATION.md](CDP_TRACK_B_FINAL_QUALIFICATION.md), with machine-readable results in `final_qualification.json`. Verification evidence is recorded in `validation.json`.
