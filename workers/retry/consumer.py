        ...
        with self._session_factory() as session:
            ...
            decision = self._decision_service.decide(
                DecisionContext(
                    ...
                    document_id=preserved.get("document_id"),
                    page_id=preserved.get("page_id"),
                    form_identity_authority=preserved.get("form_identity_authority") or {},
                    claim_membership_authority=preserved.get("claim_membership_authority") or {},
